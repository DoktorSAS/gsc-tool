...
context::context() : gsc::context(props::string_size | props::token_size | props::waitframe | props::bool_not_after_and | props::offset_8,
    engine::s2, endian::little, system::pc, max_string_id)
{
